...
import com.example.comedoressociales.adapters.AdapterCartItem;
...
public class ShopDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //each shop have its own products and orders so if user add items to cart and go back and open cart in different shop then carrt should be different
        //to delete cart ata whenever user open this activity
    ...
    public void cartCount(){
        //kee p it public so we can access in adapter
        //get cart count
        int count = easyDB.getAllData().getCount();
        if(count <= 0){
            // no item in cart, hide cart cout textview
            cartCountTv.setVisibility(View.GONE);
        }
        else{
            //have items in cart, hide cart count textview
            cartCountTv.setVisibility(View.VISIBLE);
            cartCountTv.setText("" + count);//concanate with string, because we cant set integer in textview
        }
    }
        ...
        ref.child(timestamp).setValue(hashMap)
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        prepareNotificationsMessage(timestamp);

                        //after placing order openorder details page
    ...
    private void prepareNotificationsMessage(String orderId){
        ...
        try{
            ...
            notificationBodyJo.put("buyerUid", firebaseAuth.getUid()); //since we are logged in as buyer order so current user uid is buyer uid
