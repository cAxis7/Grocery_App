package com.example.comedoressociales.adapters;
...
import com.example.comedoressociales.activities.FilterOrderShop;
import com.example.comedoressociales.activities.MainSellerActivity;
import com.example.comedoressociales.activities.OrderDetailsSellerActivity;
import com.example.comedoressociales.activities.OrderDetailsUsersActivity;
import com.example.comedoressociales.activities.ShopReviewsActivity;
...
public class AdapterOrderShop  extends RecyclerView.Adapter<AdapterOrderShop.HolderOrderShop> implements Filterable {
    ...
    public int getItemCount() {
        return orderShopArrayList.size(); // returns size of list/ number of records
    }
    ...
    //view holder class for row_order.xml
